...
description: "Quickly finds facts from chat history and files"
---

# Information Retrieval

## Overview
Quickly finds facts from chat history and files

## When to Use
This skill should be applied when:
- The task requires quickly finds facts from chat history and files
...
- Complex projects requiring quickly finds facts from chat history and files
- Situations where standard approaches were insufficient
- Premium product development requiring excellence

## Notes for AI Agents
- Always read this file when encountering tasks related to: quickly finds facts from chat history and files
