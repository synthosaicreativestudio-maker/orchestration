...
description: "Retains decisions made earlier in conversation"
---

# State Persistence

## Overview
Retains decisions made earlier in conversation

## When to Use
This skill should be applied when:
- The task requires retains decisions made earlier in conversation
...
- Complex projects requiring retains decisions made earlier in conversation
- Situations where standard approaches were insufficient
- Premium product development requiring excellence

## Notes for AI Agents
- Always read this file when encountering tasks related to: retains decisions made earlier in conversation
