...
description: "Containerization, CI/CD, infrastructure as code"
---
...
- The task requires containerization, ci/cd, infrastructure as code
...
- Complex projects requiring containerization, ci/cd, infrastructure as code
- Situations where standard approaches were insufficient
- Premium product development requiring excellence

## Notes for AI Agents
- Always read this file when encountering tasks related to: containerization, ci/cd, infrastructure as code
