---
name: "Strategic Adjusting"
category: "Planning Reasoning"
description: "Adapts plans dynamically when approaches fail"
---

# Strategic Adjusting

## Overview
Adapts plans dynamically when approaches fail

## When to Use
This skill should be applied when:
- The task requires adapts plans dynamically when approaches fail
...
- Complex projects requiring adapts plans dynamically when approaches fail
- Situations where standard approaches were insufficient
- Premium product development requiring excellence

## Notes for AI Agents
- Always read this file when encountering tasks related to: adapts plans dynamically when approaches fail
