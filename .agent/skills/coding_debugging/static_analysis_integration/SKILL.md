...
description: "Uses linters (ruff, eslint) for quality checks"
---

# Static Analysis Integration

## Overview
Uses linters (ruff, eslint) for quality checks

## When to Use
This skill should be applied when:
- The task requires uses linters (ruff, eslint) for quality checks
...
- Complex projects requiring uses linters (ruff, eslint) for quality checks
- Situations where standard approaches were insufficient
- Premium product development requiring excellence

## Notes for AI Agents
- Always read this file when encountering tasks related to: uses linters (ruff, eslint) for quality checks
