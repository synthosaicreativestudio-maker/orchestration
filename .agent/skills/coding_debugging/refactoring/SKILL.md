...
- The task requires improves code structure without changing functionality
...
- Complex projects requiring improves code structure without changing functionality
- Situations where standard approaches were insufficient
- Premium product development requiring excellence

## Notes for AI Agents
- Always read this file when encountering tasks related to: improves code structure without changing functionality
